...
Esta estratégia comparativa permitirá avaliar se uma maior intensidade dinâmica do vórtice se associa a mudanças significativas em: (i) a magnitude absoluta dos máximos de vento e precipitação; (ii) a distribuição espacial relativa de tais máximos; e (iii) os padrões estruturais dominantes identificados pelo MEOF.
