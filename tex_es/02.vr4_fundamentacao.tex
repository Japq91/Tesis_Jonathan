...
\subsection{Compositing centrado en el sistema}\label{subsec:tb_compositing}
...
\subsection{Estimación de densidad por kernel (KDE): PDF de magnitudes y de posición}\label{subsec:tb_kde}
...
\subsection{Significancia estadística mediante Bootstrap-t}\label{subsec:tb_bootstrap}
